...
<center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: #222222;" class="email-bg">
    ...
    <![endif]-->
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td valign="top" style="background-color: #ffffff; display:none" class="darkmode-bg"> 
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                <h1 style="margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;">Cancelamento</h1>
                                <p style="margin: 0 0 10px;">
									Olá   <strong>{{ $details['dados']['nome_cliente'] }}</strong>
								</p>
                                <p style="margin: 0 0 10px;">
									Seu pedido  <b>{{$details['dados']['codigo_pedido']}}</b> foi Aprovado com sucesso na data <b>{{ $details['dados']['updated_at'] }}</b>.
								</p>
                                <p style="margin: 0 0 10px;">
									Você irá partir de <b>{{$details['dados']['origem']}}</b> para <b>{{$details['dados']['destino']}}</b> em <b>{{$details['dados']['data_ida']}}</b> e volta em <b>{{$details['dados']['data_volta']}}</b> .
								</p>
                                <p style="margin: 0 0 10px;">
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
	        ...
	        <tr>
	            <td style="padding: 20px; font-family: sans-serif; font-size: 12px; line-height: 15px; text-align: center; color: #ffffff;">
					...
					<span class="unstyle-auto-detected-links">
                        ...
                        R. Maranhão, 339 - primeiro andar - Santa Efigênia, Belo Horizonte - MG, 30150-330
						<br>
                        (31) 3181-0456
					</span>
	                <!-- <br><br>
