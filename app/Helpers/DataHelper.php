...
class DataHelper {
	 ...
	 * @access public
	 */
	public static function diferencaMinutos($date_one, $date_two, $horaArredondada = true){

		//https://acervolima.com/como-calcular-a-diferenca-entre-duas-datas-em-php/#:~:text=A%20tarefa%20%C3%A9%20encontrar%20a%20diferen%C3%A7a%20entre%20duas%20datas.&text=M%C3%A9todo%201%3A%20Use%20a%20fun%C3%A7%C3%A3o,segundos%20entre%20duas%20datas%20especificadas.

		$data1 = strtotime($date_one);
		$data2 = strtotime($date_two);
